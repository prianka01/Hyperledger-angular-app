...
export class TraderComponent implements OnInit {
  ...
  firstNameCt = new FormControl('', Validators.required);
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.example.mynet.Trader',
      'tradeId': this.tradeId.value,
      'firstNameCt': this.firstNameCt.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.firstNameCt) {
        formObject.firstNameCt = result.firstNameCt;
      } else {
        formObject.firstNameCt = null;
      }
